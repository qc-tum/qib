...
class TestTensorNetwork(unittest.TestCase):
    ...
    def test_tensor_network(self):
        ...
        stn1.add_tensor(qib.tensor_network.SymbolicTensor( 3, ( 3,  5,  6,  2), "a"))
        stn1.add_tensor(qib.tensor_network.SymbolicTensor( 1, ( 7,  4,  2,  5), "b"))
        stn1.add_tensor(qib.tensor_network.SymbolicTensor( 7, ( 7,  9,  3, 17, 17), "c06"))
        stn1.add_tensor(qib.tensor_network.SymbolicTensor( 0, (13,  7,  3), "dd"))
        stn1.add_tensor(qib.tensor_network.SymbolicTensor( 5, (13, 11,  6), "e"))
        stn1.add_tensor(qib.tensor_network.SymbolicTensor(-1, ( 7,  9, 11, 17,  4,  7), None))  # virtual tensor for open axes
        stn1.add_bond(qib.tensor_network.SymbolicBond(-7, ( 3,  1),     ( 1,  3)))
        stn1.add_bond(qib.tensor_network.SymbolicBond( 3, ( 0,  7,  3), ( 2,  2,  0)))
        stn1.add_bond(qib.tensor_network.SymbolicBond(14, ( 1,  3),     ( 2,  3)))
        stn1.add_bond(qib.tensor_network.SymbolicBond(-3, ( 5,  3),     ( 2,  2)))
        stn1.add_bond(qib.tensor_network.SymbolicBond( 0, (-1,  0, -1), ( 0,  1,  5)))
        stn1.add_bond(qib.tensor_network.SymbolicBond( 2, ( 0,  5),     ( 0,  0)))
        stn1.add_bond(qib.tensor_network.SymbolicBond(11, ( 5, -1),     ( 1,  2)))
        stn1.add_bond(qib.tensor_network.SymbolicBond(13, ( 7, -1),     ( 1,  1)))
        stn1.add_bond(qib.tensor_network.SymbolicBond( 5, ( 7, -1,  7), ( 3,  3,  4)))
        stn1.add_bond(qib.tensor_network.SymbolicBond( 6, ( 1,  7),     ( 0,  0)))
        stn1.add_bond(qib.tensor_network.SymbolicBond(17, ( 1, -1),     ( 1,  4)))
        ...
        stn2.add_tensor(qib.tensor_network.SymbolicTensor( 2, ( 7, 15), "f"))
        stn2.add_tensor(qib.tensor_network.SymbolicTensor( 1, ( 9,  6, 15), "g007"))
        stn2.add_tensor(qib.tensor_network.SymbolicTensor( 3, ( 6,  4, 17, 15,  9), "h"))
        stn2.add_tensor(qib.tensor_network.SymbolicTensor(-1, ( 7,  9,  4, 17,  9), None))  # virtual tensor for open axes
        stn2.add_bond(qib.tensor_network.SymbolicBond( 4, ( 1,  3,  2), ( 2,  3,  1)))
        stn2.add_bond(qib.tensor_network.SymbolicBond(11, ( 2, -1),     ( 0,  0)))
        stn2.add_bond(qib.tensor_network.SymbolicBond( 3, (-1,  1,),    ( 1,  0,)))
        stn2.add_bond(qib.tensor_network.SymbolicBond( 6, ( 3, -1),     ( 2,  3)))
        stn2.add_bond(qib.tensor_network.SymbolicBond(16, (-1,  3),     ( 2,  1,)))
        stn2.add_bond(qib.tensor_network.SymbolicBond( 2, ( 3, -1),     ( 4,  4)))
        stn2.add_bond(qib.tensor_network.SymbolicBond( 1, ( 1,  3),     ( 1,  0)))
